...
idkwtok ('h':'i':'g':'h':'p':[])         = tok CTokHighp
idkwtok ('_':'_':'h':'i':'g':'h':'p':[])       = tok CTokHighp
idkwtok ('_':'_':'h':'i':'g':'h':'p':'_':'_':[]) = tok CTokHighp
...
idkwtok ('v':'e':'c':'3':[])             = tok CTokVec3
idkwtok ('v':'e':'c':'4':[])             = tok CTokVec4
