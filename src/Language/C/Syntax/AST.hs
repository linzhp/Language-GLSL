...
data CTypeQual = CConstQual NodeInfo
               ...
               | CUniformQual NodeInfo
               | CMediumpQual NodeInfo
               | CVaryingQual NodeInfo
               deriving (Data,Typeable {-! CNode !-})
...
instance CNode CTypeSpec
    where nodeInfo (CVoidType nodeinfo) = nodeinfo
          ...
          nodeInfo (CVec3Type nodeinfo) = nodeinfo
          nodeInfo (CVec4Type nodeinfo) = nodeinfo
...
instance CNode CTypeQual
    where nodeInfo (CConstQual nodeinfo) = nodeinfo
          ...
          nodeInfo (CUniformQual nodeinfo) = nodeinfo
          nodeInfo (CMediumpQual nodeinfo) = nodeinfo
          nodeInfo (CVaryingQual nodeinfo) = nodeinfo
